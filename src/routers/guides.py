...
ANDROID_VIDEOGUIDE_TELEGRAM_FILE_ID = (
    'BAACAgIAAxkDAAIGbmkoSVUKRiXnSiS_Z5KdU6vyWbEcAAKhhgACTKZASXTmqBDtZYIBNgQ'
)
APPLE_VIDEOGUIDE_TELEGRAM_FILE_ID = (
    'BAACAgIAAxkDAAIGbGkoSOgQtUIfBBuBYJP9x7pqRQ9qAAKbhgACTKZASed4cE54lQAB5zYE'
)
WINDOWS_VIDEOGUIDE_TELEGRAM_FILE_ID = (
    'BAACAgIAAxkDAAIFymkid51O4V_dq9yl1gAB1EVjuUlH2wACNY0AApbYEUny-pLBIMJBTTYE'
)
